...
import { Activity, BarChart3, CheckCircle, Copy, ShieldCheck, TrendingUp, User, Wallet, Zap } from 'lucide-react';
        ...
        <div className='account-dashboard-page'>
            <div className='dashboard-header'>
                    ...
                    <div className='user-info'>
                        <div className='name-row'>
                            {isEditingName ? (
                                ...
                                <h1 title='Click to edit' onClick={() => setIsEditingName(true)}>
                                    {username}
                                </h1>
                            )}
                ...
                <div className='header-stats'>
                    <StatCard label='Profile Reach' value='98%' sub='Optimized for speed' icon={Zap} color='blue' />
                    <StatCard
                        label='Trust Score'
                        value='Excel'
                        sub='Verified Member'
                    ...
                    <StatCard
                        ...
                        pulse
                    />
                    <StatCard label='Growth Edge' value='+12.5%' sub='Monthly ROI' icon={TrendingUp} color='cyan' />
                </div>
            </div>
