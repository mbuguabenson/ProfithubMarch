        ...
        const fetchProfitTable = async () => {
            try {
                ...
                if (res.profit_table?.transactions) {
                    ...
                    const parsedWinRate = Array.from(assetMap.entries())
                        .map(([asset, s]) => ({
        ...
        <div className='account-tab-wrapper'>
            <div className='grid-5'>
                <StatBadge
                    ...
                    sub={`Target Meta reached`}
                    icon={Target as any}
                    color='blue'
                />
                <StatBadge
                    label='Reward Cluster'
            ...
            <div className='grid-2'>
                <div className='glass-card hoverable'>
                    <div
                        ...
                        style={{ width: '200px', height: '200px', filter: 'blur(100px)', opacity: 0.1 }}
                    />
                ...
                <div className='glass-card hoverable'>
                    <div
                        className='card-bg-glow top-left purple'
                        style={{ width: '200px', height: '200px', filter: 'blur(100px)', opacity: 0.1 }}
                    />
            ...
            <div className='glass-card'>
                <div
                    className='card-bg-glow bottom-center blue'
                    style={{
                        width: '500px',
                        height: '100px',
                        filter: 'blur(100px)',
