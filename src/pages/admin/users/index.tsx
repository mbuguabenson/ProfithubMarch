...
import {
    ...
    X, TrendingUp, TrendingDown, AlertTriangle, RefreshCw,
} from 'lucide-react';
    ...
    <div style={{ padding: '2rem' }}>
        {Array.from({ length: 6 }).map((_, i) => (
            <div key={i} style={{
                ...
                <div style={{ flex: 1 }}>
                    <div style={{ height: 12, width: '40%', background: 'rgba(255,255,255,0.08)', borderRadius: 6, marginBottom: 8 }} />
        ...
        <div className="admin-users-page">
            ...
            <div className="users-header">
                ...
                <p className="subtitle">
                    ...
                    {admin.isLoading ? 'Loading...' : `${users.length} registered nodes`}
                </p>
                <button
            ...
            <div className="filter-badges">
                {[
                    ...
                    { key: 'Real', label: 'Real Accounts', count: users.filter(u => u.type === 'Real').length, color: 'purple' },
                    { key: 'Demo', label: 'Demo Accounts', count: users.filter(u => u.type === 'Demo').length, color: 'cyan' },
                ...
                {admin.isLoading ? (
                    ...
                    <div className="table-scroll">
                        <table>
                            <thead>
                                <tr>
                                    {['User', 'Account', 'Currency', 'History', 'Country', 'Status', 'Last Seen', ''].map(h => (
                                        <th key={h}>{h}</th>
                                    ))}
                                </tr>
                            </thead>
                                    ...
                                    <tr>
                                        <td colSpan={8}>
                                            <div className="empty-state">
                                                ...
                                                <p>{users.length === 0 ? 'No users found in database' : 'No users match your search'}</p>
                                            </div>
                                        </td>
                                    </tr>
                                ) : (
