                        ...
                        {active_section === 'console' && (
                            <div className='p-8 min-h-screen bg-[#050505]'>
                                <div className='mb-6'>
                                    ...
                                    <p className='text-slate-600 text-[9px] font-mono font-black uppercase tracking-[0.3em] mt-1'>
                                        Administrative terminal • Platform command interface
                                    </p>
                                </div>
                                <TradingConsole />
                            </div>
                            ...
                            <div className='p-8'>
                                <div className='rounded-3xl border border-white/5 bg-white/[0.02] p-12 text-center'>
                                    ...
                                    <p className='text-slate-400 max-w-md mx-auto'>
                                        The <strong>{active_section}</strong> module is being configured with real-time
                                        data streams.
                                    </p>
                                </div>
                            </div>
